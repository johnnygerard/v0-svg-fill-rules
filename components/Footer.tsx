...
const Footer: React.FC = () => {
  return (
    <footer className="mt-12 py-6 border-t border-gray-200">
      <div className="text-center text-sm text-gray-600 flex flex-col items-center gap-4">
        <p className="flex items-center gap-2">
          Code exclusively generated by{' '}
          <a
            href="https://v0.dev"
            target="_blank"
          ...
          >
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/icon-dark-192x192-FD6MBd3xv4jCLBc8mg4TGIOSYyRFfm.png"
              alt="v0 logo"
              width={24}
              height={24}
